...
/**
 * Create video thumbnails by delegeting the job directly to ffmpeg
 */
Thumbnailer.prototype.videoThumbnail = function () {
	thumbnailCommand = 'ffmpeg  -itsoffset -1  -i ' +  this.localPath + ' -vcodec mjpeg -vframes 1 -an -y -f rawvideo -s ' + this.width + 'x' + this.height + ' ' + this.convertedPath;

...
Thumbnailer.prototype.cropped = function() {
  var qualityString = (this.quality ? '-quality ' + this.quality : ''),
    thumbnailCommand = config.get('convertCommand') + ' "' + this.localPath + '[0]" -resize ' + this.width + ' -gravity center -crop ' + this.width + 'x' + this.height + '+0+0 ' + qualityString + ' ' + this.convertedPath;
